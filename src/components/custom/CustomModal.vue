  ...
  >
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        >
          <div
            class="flex flex-col justify-center items-center relative px-4 pb-4 pt-5 sm:p-6 sm:pb-4"
          >
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:text-left">
                <h3
                  class="text-center font-bold leading-10 text-darkMode dark:text-lightMode mb-3"
                  id="modal-title"
                >
                  {{ title }}
                </h3>
                <div class="relative w-full min-w-[300px] h-11">
                  <input
                    ...
                    class="peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 disabled:cursor-not-allowed transition-all border-b placeholder-shown:border-blue-gray-200 placeholder:opacity-0 focus:placeholder:opacity-100 text-sm pt-4 pb-1.5 border-blue-gray-200 focus:border-gray-500"
                  /><label
