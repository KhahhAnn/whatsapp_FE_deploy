...
<template>
  <div v-show="isOpen" class="fixed bottom-20 left-80 w-96 h-96 bg-lightMode border border-gray-300 rounded-lg shadow-lg overflow-auto transition-opacity duration-300 ease-in-out opacity-100 pointer-events-auto">
      <div class="p-4">
          <input
              type="text"
              v-model="searchQuery"
